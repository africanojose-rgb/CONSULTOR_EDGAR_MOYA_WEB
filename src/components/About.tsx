...
export default function About() {
  return (
    <section id="about" className="py-24 bg-dark-card border-y border-dark-border/60 relative overflow-hidden">
      <div className="absolute top-1/4 left-0 w-80 h-80 bg-gold/5 blur-3xl rounded-full -translate-x-1/2" aria-hidden="true"></div>
      <div className="absolute bottom-1/4 right-0 w-80 h-80 bg-primary/5 blur-3xl rounded-full translate-x-1/2" aria-hidden="true"></div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            <div className="border-l-4 border-gold bg-primary/10 p-6 rounded-r-xl mt-6 relative">
              <span className="font-serif text-5xl text-gold/15 absolute top-2 right-4 pointer-events-none font-bold" aria-hidden="true">&ldquo;</span>
              <p className="font-serif text-lg text-gold-light italic font-medium leading-relaxed">
                &ldquo;La justicia es la constante y perpetua voluntad de dar a cada uno lo suyo.&rdquo;
              </p>
              <p className="text-xs text-gray-400 mt-2 uppercase tracking-wider font-sans">&mdash; Ulpiano, Digesto</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-dark-bg border border-dark-border p-8 rounded-xl flex flex-col justify-between hover:border-gold/40 transition-colors duration-300 shadow-xl relative group">
              <div className="absolute top-0 right-0 w-16 h-16 bg-gold/5 rounded-bl-full -z-10" aria-hidden="true"></div>
              <Award className="w-8 h-8 text-gold mb-6" aria-hidden="true" />
              <div>
                <p className="font-serif text-4xl font-bold text-white mb-2">39</p>
            ...
            <div className="bg-primary border border-primary/40 p-8 rounded-xl flex flex-col justify-between hover:border-gold/40 transition-all duration-300 shadow-xl relative group">
              <div className="absolute top-0 right-0 w-16 h-16 bg-white/5 rounded-bl-full -z-10" aria-hidden="true"></div>
              <Briefcase className="w-8 h-8 text-gold-light mb-6" aria-hidden="true" />
              <div>
            ...
            <div className="sm:col-span-2 bg-gradient-to-r from-primary/15 to-gold/5 border border-gold/25 p-8 rounded-xl flex items-start gap-4 shadow-xl">
              <Compass className="w-8 h-8 text-gold shrink-0 mt-1" aria-hidden="true" />
